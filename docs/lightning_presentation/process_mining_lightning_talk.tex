...
\includegraphics[width=\textwidth]{Process-Mining-1.png}
\end{column}
\begin{column}{0.5\textwidth}
\begin{itemize}
...
\vspace{1em}
\textit{\small ``Process mining is the missing link between model-based process analysis and data-oriented analysis techniques.''}
\end{column}
\end{columns}
\end{frame}
